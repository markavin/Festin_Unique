...
export function CreateTransaksi() {
  return (
    <Link
      ...
      className="flex h-10 items-center rounded-lg bg-gradient-to-b from-gray-800 to-red-900 px-4 text-sm font-medium text-white transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
    >
...
export function UpdateTransaksi({ id }: { id: string }) {
  return (
    ...
    href={`/dashboard/transaksi/${id}/edit`}
      className="rounded-md border p-2 bg-gradient-to-b from-gray-800 to-red-900 hover:bg-gray-100 text-white"
    >
