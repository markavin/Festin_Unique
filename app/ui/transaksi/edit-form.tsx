...
import { CustomerField, TransaksiForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={transaksi.customer_id}
            >
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={transaksi.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  defaultChecked={transaksi.status === 'paid'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="paid"
